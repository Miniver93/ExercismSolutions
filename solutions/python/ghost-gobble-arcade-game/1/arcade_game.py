...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    return True if has_eaten_all_dots and not touching_ghost else False or True if has_eaten_all_dots and power_pellet_active and touching_ghost else False
